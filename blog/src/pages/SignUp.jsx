...
<div className=" flex flex-row w-full max-w-4xl bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="w-3/5 space-y-6">
          <h2 className="text-5xl font-bold leading-none text-[#030622] text-center text-gray-900 mb-5">Sign Up</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              <input
                ...
                className="peer w-3/4 px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              />
              <label
                htmlFor="email"
                className="absolute left-4 top-1/2 transform -translate-y-1/2 text-sm text-gray-500 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-700 peer-focus:text-xs peer-focus:text-blue-500 peer-focus:top-0 peer-focus:transform peer-focus:-translate-y-5 transition-all"
              >
                Email
              </label>
            </div>
            ...
            <button className="bg-white border border-green-400 hover:bg-green-400 hover:text-white text-green-400 font-bold text-md py-2 px-6 rounded-full mt-4">
        Sign Up
      </button>
          </form>
          ...
          {/* Footer Text */}
          <div className="mt-4  ml-40 py-18 text-center text-xs text-gray-600">
            <p>
        ...
        {/* Vertical Line and Social Buttons Section */}
        <div className="flex flex-col justify-center items-center w-2/5 space-y-4 relative">
          

          <div className=" w-full mt-1 ml-8 -mt-10 -ml-5">
            {/* Google Button */}
            <button className="w-full  flex items-center justify-start  space-x-2 border border-gray-300 rounded-md mb-4">
            <svg xmlns="http://www.w3.org/2000/svg"  width="50" height="50" viewBox="0 0 100 100" className='mr-8 ml-2'>
